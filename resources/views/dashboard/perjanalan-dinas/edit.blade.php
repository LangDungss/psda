...
@section('dashboard-content')
    <div class="container px-6 mx-auto grid">
        <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
            EDIT PENGAJUAN PERJALAN DINAS
        </h2>
        <!-- Form mulai -->
        <form action="{{ route('perjalanan-dinas.update',['id' => $pengajuans->id]) }}" method="POST">
            @method('PUT')
            ...
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <label class="block text-sm" for="kepada" id="kepada">
                    ...
                    <input type="text"
                        ...
                        name="kepada" placeholder="kepada" value="{{ old('kepada', $pengajuans->kepada) }}" />
                </label>
                <label class="block mt-4 text-sm" for="perihal" id="perihal">
                    ...
                    <textarea name="perihal"
                        ...
                        rows="3" placeholder="masukkan tujuan dari keberangkatan.">{{ old('perihal', $pengajuans->perihal) }}</textarea>
                </label>
                ...
                <label class="block mt-4 text-sm" for="tgl_berangkat" id="tgl_berangkat">
                    ...
                    <input type="date"
                        ...
                        value="{{ old('tgl_berangkat', $pengajuans->tgl_berangkat) }}" />
                </label>
                <label class="block mt-4 text-sm" for="tgl_kembali" id="tgl_kembali">
                    ...
                    <input type="date"
                        ...
                        value="{{ old('tgl_kembali', $pengajuans->tgl_kembali) }}" />
                </label>
                ...
                <label class="block text-sm mt-4" for="jml_hari" id="jml_hari">
                    ...
                    <input type="text" disabled
                        ...
                        name="jml_hari" placeholder="jumlah hari." value="{{ old('jml_hari', $pengajuans->jml_hari) }}" />
                </label>
                ...
                <label class="block text-sm mt-4" for="sumber_anggaran" id="sumber_anggaran">
                    ...
                    <input type="text"
                        ...
                        value="{{ old('sumber_anggaran', $pengajuans->sumber_anggaran) }}" />
                </label>
                ...
                <label class="block text-sm mt-4" for="anggota" id="anggota">
                    ...
                    <input type="text"
                        class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                        name="anggota" placeholder="Masukkan anggota." value="{{ old('anggota', $pengajuans->anggota) }}" />
                </label>
                ...
                <label class="block text-sm mt-4" for="transportasi" id="transportasi">
                    ...
                    <input type="text"
                        ...
                        value="{{ old('transportasi', $pengajuans->transportasi) }}" />
                </label>
